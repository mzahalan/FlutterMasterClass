  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Card(
        ...
        child: Padding(
          padding: selected ? const EdgeInsets.all(15) : const EdgeInsets.all(8), 
          child: Row(
            children: [
              Image.asset('assets/img/vocations/${vocation.image}', width: 80, colorBlendMode: BlendMode.color, color: !selected ? Colors.black.withAlpha(200): Colors.transparent),
